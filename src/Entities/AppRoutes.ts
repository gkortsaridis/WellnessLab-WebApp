...
export const HEALTH_EXPERIENCES = "/dev/actions/health_experiences"
export const SEMINARS = "/dev/actions/seminars"
export const TV_INTERVIEW = "/dev/actions/tv_interview"
